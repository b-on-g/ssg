...
declare namespace $ {
	...
	type $mol_text__text_bog_ssg_1 = $mol_type_enforce<
		ReturnType< $bog_ssg['content_text'] >
		,
		ReturnType< $mol_text['text'] >
	>
	export class $bog_ssg extends $mol_page {
		Theme( ): $mol_theme_auto
		page_title( ): string
		content_text( ): string
		Content( ): $mol_text
		plugins( ): readonly(any)[]
		title( ): ReturnType< $bog_ssg['page_title'] >
		body( ): readonly(any)[]
	}
	
}

//# sourceMappingURL=ssg.view.tree.d.ts.map
declare namespace $.$$ {
