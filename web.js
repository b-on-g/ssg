...
;
	($.$bog_ssg) = class $bog_ssg extends ($.$mol_page) {
		Theme(){
	...
	($mol_mem(($.$bog_ssg.prototype), "Theme"));
	($mol_mem(($.$bog_ssg.prototype), "Content"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $bog_ssg.prototype, "page_slug", null);
        __decorate([
            $mol_mem
        ], $bog_ssg.prototype, "page_title", null);
        __decorate([
            $mol_mem
        ], $bog_ssg.prototype, "content_text", null);
        $$.$bog_ssg = $bog_ssg;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
